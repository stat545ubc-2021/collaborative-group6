...
# We can choose to use install.packages() if packages are not installed, but no need to keep in Rmarkdown and knit with them. For example:
# install.packages(c('dslabs', 'stringr', 'gapminder') 
